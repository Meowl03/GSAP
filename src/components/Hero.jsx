...
.to('.left-leaf', { rotation: -30, transformOrigin: 'bottom center' }, 0)  // Rotate counter-clockwise
.to('.right-leaf', { rotation: 30, transformOrigin: 'bottom center'}, 0)   // Rotate clockwise
